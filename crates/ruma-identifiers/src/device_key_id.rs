...
mod tests {
    ...
    fn serialize_device_key_id() {
        let device_key_id = Box::<DeviceKeyId>::try_from("ed25519:JLAFKJWSCS").unwrap();
    ...
    fn deserialize_device_key_id() {
        ...
        let expected = Box::<DeviceKeyId>::try_from("ed25519:JLAFKJWSCS").unwrap();
    ...
    fn missing_key_algorithm() {
        assert_eq!(
            Box::<DeviceKeyId>::try_from(":JLAFKJWSCS").unwrap_err(),
    ...
    fn missing_delimiter() {
        assert_eq!(
            Box::<DeviceKeyId>::try_from("ed25519|JLAFKJWSCS").unwrap_err(),
    ...
    fn empty_device_id_ok() {
        assert!(Box::<DeviceKeyId>::try_from("ed25519:").is_ok());
    }
